<template>
  <div>
    ...
    <ValidationObserver v-if=" !is_clone" class="w-full" v-slot="{ invalid, handleSubmit }">
      <form @submit.prevent="is_submit=true,handleSubmit(doSubmit)">
        ...
        <div v-if="fromSingle" id="product_form" class="tab-sidebar p-3">
          ...
          <div class="grid grid-cols-3 gap-4">
            ...
            <ValidationProvider name="parentCategory" :rules="{required: true}" v-slot="{ errors }"
              ...
              <div class="form-group input-wrapper for-lang ar-lang">
                <label class="w-full" for="mainCategory">{{ $t("rfq.Search by Category") }} {{ isRfqProduct }} <strong
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <ValidationProvider name="Brand" :rules="{ required: !is_draft && !result.brand_id }" v-slot="{ errors }"
              ...
              <div class="w-full mt-3 mt-sm-0">
                <label class="w-full">{{ $t('prod.Select Brand') }} <strong class="text-error">*</strong></label>
                <select :disabled="is_show" class="form-control w-full p-2  border border-smooth rounded-lg uppercase"
            ...
            <ValidationProvider v-if="isRfqProduct" name="sku" :rules="skuRules" v-slot="{ errors }"
                                :custom-messages="{required: $t('global.req', { type: $t('prod.SKU')}) }">
              <div class="form-group w-full  mt-3 mt-sm-0">
        ...
        <div class="tab-sidebar p-3" v-if="is_variant && !fromSingle">
          ...
          <div class="form-group input-wrapper for-lang ar-lang">
            ...
            <select :disabled="is_show" class="w-full rounded border mb-10 border-smooth p-3 uppercase"
                ...
                <td>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input :disabled="is_show" class="form-control w-100" type="text" placeholder="Enter Value"
          ...
          <div class="tab-sidebar p-3" v-else>
            ...
            <div class="card-body mt-10" v-if="is_variant">
              ...
              <div class="input-wrapper mb-10" v-if="is_variant">
                ...
                <input :disabled="is_show" class="form-control" name="e.g. Macbook Pro 2019"
                       :placeholder="$t('prod.parent_sku')"
                       type="text"
    ...
    <span class="p-3 border border-smooth rounded cursor-pointer">
      <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
        ...
        <div class="tab-sidebar p-3" v-if="!is_variant">
          ...
          <div class="grid grid-cols-2 gap-4">
            <ValidationProvider name="unit" :rules="NotDraftValidationRules" v-slot="{ errors }"
                                :custom-messages="{required: $t('global.unit', { type: $t('prod.unit')}) }">
              <div class="input-wrapper">
            ...
            <ValidationProvider v-if="isRfqProduct" name="selling price" rules="required" v-slot="{ errors }"
                                :custom-messages="{required: $t('global.selling_price', { type: $t('prod.Selling price')}) }">
              <div class="input-wrapper">
          ...
          <div v-if="!isRfqProduct">
            <p><span class="fw-bold">{{ $t('prod.Price list') }}</span></p>
            <p>
              {{
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="tab-sidebar p-3" v-if="!is_variant">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div v-if="!isRfqProduct" class="col-md-6">
              <div class="input-wrapper">
                <label for="">{{ $t('prod.Availability') }}</label>
                <select :disabled="is_show" class="border p-3 w-full border-smooth rounded-lg uppercase" disabled
        ...
        <div class="tab-sidebar p-3" v-if="!is_variant && !isRfqProduct">
          ...
          <div class="form-group input-wrapper mb-10 for-lang ar-lang">
            ...
            <input :disabled="is_show" class="form-control" :placeholder="$t('prod.hts_code')" type="text"
...
import ProductCloneSection from "../product/ProductCloneSection.vue";
