            ...
            <div class="flex flex-col">
              <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                  <div class="overflow-hidden">
                    <div class="overflow-y-scroll max-h-[300px] scroll-thin">
      ...
      <div v-if="secondBox" class="secondStep p-4">
        <div class="card p-4">
          <div class="flex justify-between">
            ...
            <a v-if="$can('edit_addresses')" class="border border-smooth bg-primary text-white p-4 leading-3 rounded-lg"
      ...
      addressSelected.id !== address.id
        ...
        <div class="w-full border-t mb-2 p-2 border-smooth">
          <div class="items-end p-1 text-end absolute ltr:right-[40px] rtl:left-[40px]">
            ...
            <button @click="backSecondStep" class="bg-smooth px-4 w-[100px] text-primary p-3 rounded leading-3">
              {{ $t('approveModal.back') }}
            </button>
            <button @click="secondStep" v-if="addressSelected"
      ...
      <div v-if="thirdBox" class="thirdStep p-4">
        ...
        <div class="w-full border-t p-2 mb-2 border-smooth">
          ...
          <div class="items-end p-1  text-end absolute ltr:right-[40px] rtl:left-[40px]">
            ...
            <button @click="backThirdStep" class="bg-smooth px-4 w-[100px] text-primary p-3 rounded leading-3">
              {{ $t('approveModal.back') }}
            </button>
            <button @click="approveSave" class="bg-primary px-4 w-[100px] text-white p-3 rounded leading-3">
              {{ $t('approveModal.save') }}
            </button>
          </div>
        </div>
...
export default {
  components: {OrderItems, CardTab, OrderSummary, PriceWithCurencyFormat, AddAddressModel, LazyImage, Pagination},
  computed: {
