<template>
  <div>
    <div>
      <list-page ref="listPage" list-api="getNotApprovalVendor" route-name="vendors" empty-store-variable="allProducts"
        :name="$t('title.prod')" @list="itemList = $event">
            ...
            <table>
              ...
              <tbody>
                <tr v-for="(value, index) in list" :key="index">
                  <td>{{ index + 1 }}</td>
                  <td><a class="text-primary" href=""><img
                        src="https://cfn-catalog-prod.tradeling.com/up/6329c4504efabf903adf35b1/960590de34aa9587df59041183754f83.jpg"
                        alt=""></a></td>
                  <td>
                  ...
                  <td class="status" :class="{ active: value.verified == 1 }">
                  ...
                  <td>
                    <div class="flex gap-4">
                      ...
                      <button class="leading-4" @click="approval(value.id)">
                        Verified
                      </button>
                    </div>
                    ...
                    <div class="fixed bg-modal  inset-0 z-50 flex items-center justify-center">
                      ...
                      <div class="z-50 bg-white p-6 relative rounded-md shadow w-full md:w-1/2 lg:w-2/3 xl:w-1/5">
                        ...
                        <div class="flex justify-end gap-4">
                          ...
                          <button @click="approval(value.id)"
