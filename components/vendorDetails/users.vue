        ...
        <tr v-for="(value, index) in list" :key="index">
          ...
          <td><div class="flex gap-4">
           ...
           <svg class="w-4 h-4 cursor-pointer text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 14">
            ...
            <button @click="$refs.listPage.deleteItem(value.id)">
...
<DeleteModal v-if="deleteModal" @closeModal="closeModal">
    ...
    <template v-slot:buttons>
      <div class="flex gap-4 justify-end">
        ...
        <button class="p-2 border border-smooth bg-primary text-white  rounded leading-3 w-[60px] hover:text-primary">Agree</button>
      </div>
    </template>
</DeleteModal>
  </div>
