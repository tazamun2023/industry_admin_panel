      ...
      <div class="w-full">
        <ul class="flex mb-0 list-none flex-wrap pt-3 w-50 pb-4 flex-row">
          ...
          <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
            <nuxt-link
              class="text-xs font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal"
              v-bind:class="{'text-pink-600 bg-white border-white border-t-4': openTab !== 'order_placed', 'border-t-4 border-primary': openTab === 'order_placed'}"
              :to="`/rfq/manage-quotes/order-placed`"
              :title="$t('app.Order Placed')"
            >
              {{ $t("app.Order Placed") }}
            </nuxt-link>
          ...
          <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
            <nuxt-link
              v-if="$store.state.admin.isVendor"
              class="text-xs font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal"
              v-bind:class="{'text-pink-600 bg-white border-white border-t-4': openTab !== 'draft_quotes', 'border-t-4 border-primary': openTab === 'draft_quotes'}"
              :to="`/rfq/manage-quotes/draft-quotes`"
              :title="$t('app.Draft Quotes')"
            >
              {{ $t("app.Draft Quotes") }}
            </nuxt-link>
          </li>
                            ...
                            <tr>
                              ...
                              <td class="rtl:text-end">
                                ...
                                <p class="m-0 flex gap-2"><img class="w-5 h-5 mt-1"
                                  ...
                                  {{ $t("rfq.RFQ ID") }}: </strong> RFQ{{ value.rfq.id }}</p>
                              </td>
                            </tr>
                          </table>
                        </div>
