<template>
  <data-page
    ...
    :validation-keys="['image','icon','title.ar','title.en','meta_title.ar','meta_title.en', 'meta_description.ar', 'meta_description.en']"
    :result="result"
    @result="resultData"
  >
...
<!--        <label>{{ $t('category.mDesc') }}</label>-->
        <lang-input :hasError="hasError" type="short_description" :title="$t('category.mDesc')" :valuesOfLang="result.meta_description"
                    @updateInput="updateInput"></lang-input>
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div class="input-wrapper">
