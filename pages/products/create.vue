...
<div>
    ...
    <div class="tab-sidebar">
        ...
        <div class="input-wrapper p-3">
                <input type="checkbox" class="custom-control-input" id="clonecheck">
                <label class="custom-control-label fw-bold" for="clonecheck"><strong style="line-height: 26px;">Clone from existing product</strong></label>
            </div>

            <form action="" class="p-3" id="product_sku">
                <div class="input-wrapper">
                    ...
                    <label style="font-size:12px;" for="">You can find it on the Product details page in the ‘Overview’ section</label>
                </div>
                ...
                <div class="d-flex justify-content-between  align-items-center">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                            <div class="form-group input-wrapper for-lang ar-lang">
                                <label class="w-full" for="name">Select Main Category</label>
                                <select class="w-full mb-10 rounded border border-smooth p-3" name="" id="">
                                    <option value="">category 1</option>
                                    <option value="">category 1</option>
                                </select>
                            </div>
                            <div  class="form-group input-wrapper for-lang ar-lang">
                                <label  class="w-full" for="name">Select Sub Category</label>
                                <select class="w-full rounded border mb-10 border-smooth p-3" name="" id="">
                                    <option value="">category 1</option>
                                    <option value="">category 1</option>
                                </select>
                            </div>
                            <div class="form-group input-wrapper for-lang ar-lang">
                                <label  class="w-full"  for="name">Select Child Category</label>
                                <select class="w-full rounded border mb-10 border-smooth p-3" name="" id="">
                                    <option value="">category 1</option>
                                    <option value="">category 1</option>
                                </select>
                    ...
                    <div class="form-check">
                      ...
                      <div class="grid grid-cols-3 gap-4 pt-4">
                        ...
                        <div class="col-md-4"></div>
                            ...
                            <div class="col-md-4">
                               <span class="p-3 border border-smooth rounded cursor-pointer"><svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
...
<div class="tab-sidebar p-3">
    ...
    <div class="card-body">
            <div class="input-wrapper mb-10">
                ...
                <div class="flex">
                    <input class="form-control required" name="Type keyword and press enter (eg. Laptop)..." type="text" value="">
            ...
            <div class="input-wrapper mb-10">
                ...
                <div class="flex">
                    <input dir="rtl" class="form-control required" name="Type keyword and press enter (eg. Laptop)..." type="text" value="">
                    <button type="submit" class="btn ml-2 mr-2  btn-primary">
                        <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16"/>
                        </svg>
...
<div class="tab-sidebar p-3">
    ...
    <div class="input-wrapper">
        ...
        <li class="-mb-px mr-2 last:mr-0 cursor-pointer  flex-auto text-center">
          <a class="text-xs font-bold uppercase px-5 py-3  block leading-normal" v-on:click="toggleTabs(1)" v-bind:class="{'bg-white border-white border-b-2': openTab !== 1, 'border-b-2 border-primary': openTab === 1}">
            Selected Media (0 of 16)
          </a>
        </li>
        <li class="-mb-px mr-2 last:mr-0 cursor-pointer flex-auto text-center">
          <a class="text-xs font-bold uppercase px-5 py-3   block leading-normal" v-on:click="toggleTabs(2)" v-bind:class="{'bg-white border-white border-b-t': openTab !== 2, 'border-b-2 border-primary': openTab === 2}">
        ...
        <div class="flex-auto ">
          <div class="tab-content input-wrapper tab-space">
            <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
              <div @click="uploadModalToggle()" class="text-center cursor-pointer p-4 border border-dotted border-smooth rounded">
                <svg class="w-6 h-6 mx-auto text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                ...
                <div class="grid grid-cols-2 px-3 gap-4">
                        ...
                        <div class="col-md-6">
                            <div class="flex flex-row-reverse">
                                ...
                                <input style="width:200px" type="text" class="form-control m-1" id="inlineFormInput" placeholder="Search">
                                ...
                                <table class="table mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td  style="width:60%">
                                                <div class="media">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users align-self-center icon-dual icon-lg mr-4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                            ...
                                            <td><button class="btn btn-light btn-sm"><svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <svg class="w-2 h-2 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            <td><span  class="text-xs">1/3/2024, 2:38:20 PM</span></td>
                                            <td><button class="btn btn-light btn-sm"><svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
    <path d="M10 0C4.612 0 0 5.336 0 7c0 1.742 3.546 7 10 7 6.454 0 10-5.258 10-7 0-1.664-4.612-7-10-7Zm0 10a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z"/>
  </svg></button></td>
                                        </tr>
                                    </tbody>
                                ...
                                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                                    ...
                                    <a href="#" aria-current="page" class="relative z-10 inline-flex items-center bg-primary px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">1</a>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="input-wrapper mt-3 mt-sm-0">
            ...
            <div class="form-group input-wrapper mt-3 mt-sm-0">
                <label>Barcode</label>
                <input type="text" class="form-control not-allowed-cursor bgdark" placeholder="Please enter barcode number" disabled>
            </div>
            <div class="form-group input-wrapper  mt-3 mt-sm-0">
                <label>SKU</label>
...
<div class="tab-sidebar p-3">
  ...
  <input type="text" class="form-control pr-12" placeholder="Size" aria-label="Recipient's username" aria-describedby="button-addon2">
    ...
    <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
      ...
      <option value="3">Product does not have barcode number</option>
        ...
        <div class="input-wrapper">
            ...
            <div class=" mb-3">
                <input type="text" class="form-control" placeholder="Size" aria-label="Units per carton" aria-describedby="button-addon2">
            </div>
        </div>
        <div class="input-wrapper">
            <label for="">Average lead time (Days) ?</label>
            <div class=" mb-3">
                <input type="text" class="form-control" placeholder="Avg. Lead Time" aria-label="Units per carton" aria-describedby="button-addon2">
            </div>
        </div>
        <div class="input-wrapper">
...
<div class="tab-sidebar p-3">
    ...
    <p>Enter the dimensions and weight of the carton to help calculate shipping rate. These measurements are for the product's shipping container.</p>
    <div class="grid grid-cols-2 gap-4">
                <div class="input-wrapper">
                    <label for="">Weight ?</label>
                    <div class="relative flex input-group gap-4 mb-3">
                    <input type="text" class="form-control pr-12" placeholder="Carton Weight" aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="absolute right-0 top-0">
                        <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                        <option value="0">KG</option>
                        <option value="1">LB</option>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="relative flex input-group gap-4 mb-3">
                    <input type="text" class="form-control pr-12" placeholder="Carton Length" aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="absolute right-0 top-0">
                        <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                        <option value="0">KG</option>
                        <option value="1">LB</option>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="relative flex input-group gap-4 mb-3">
                    <input type="text" class="form-control pr-12" placeholder="Carton Height" aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="absolute right-0 top-0">
                        <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                        <option value="0">KG</option>
                        <option value="1">LB</option>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="relative flex input-group gap-4 mb-3">
                    <input type="text" class="form-control pr-12" placeholder="Carton Width" aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="absolute right-0 top-0">
                        <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                        <option value="0">KG</option>
                        <option value="1">LB</option>
    ...
    <div class="grid grid-cols-4 gap-4">
        <div class="input-wrapper">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Enter Length" aria-label="Recipient's username" aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="input-wrapper">
                    <label for="">Height ?</label>
                    <div class="input-group mb-3">
                        <input  type="text" class="form-control" placeholder="Enter Height" aria-label="Recipient's username" aria-describedby="button-addon2">
                    </div>
                </div>
                ...
                <div class="input-wrapper">
                    <label for="">Width ?</label>
                    <div class="input-group mb-3">
                        <input  type="text" class="form-control" placeholder="Enter Width" aria-label="Recipient's username" aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="input-wrapper">
...
<div class="tab-sidebar p-3">
    ...
    <p>Add pricing to your product. You can also create bulk pricing rules to offer price discounts based on quantity breaks</p>
    <div class="table-responsive">
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-2"><button type="submit" class="btn  btn-outline-secondary">
                               <span><svg class="w-4 h-4 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
...
<div class="tab-sidebar p-3">
    ...
    <h4  class="header-title mt-0 text-capitalize mb-1 ">Additional attributes <span class="text-xs">(optional)</span></h4>
    <div class="input-wrapper">
        <div class="flex">
    ...
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      ...
      <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          ...
          <div class="sm:items-start">
            <div class="mt-3 ">
              <div class="flex justify-between pb-20 title">
                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Please choose a new product creation option</h3>
              <svg @click="uploadModalToggle()" class="w-4 h-4  cursor-pointer text-gray-800 dark:text-white mt-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
              </div>
              <div class="mt-2">
                <div class="flex w-full py-4 items-center justify-center bg-grey-lighter">
                    <label class="w-64 flex flex-col items-center px-4 py-2 bg-white text-primary rounded-lg shadow tracking-wide uppercase border border-smooth cursor-pointer hover:bg-primary hover:text-white">
        ...
        <div class="pt-20 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
          <button type="button" class="inline-flex w-full justify-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:text-primary  sm:ml-3 sm:w-auto">Upload</button>
          <button  @click="uploadModalToggle()"  type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancel</button>
        </div>
      </div>
    </div>
  </div>
