<template>
                ...
                <div class="grid grid-cols-4">
                    <div class="p-4">
                        <div class="flex gap-4 p-2 justify-between">
                            ...
                            <button @click="varientModal = true" class="border border-smooth p-2 gap-4 w-[140px] leading-3 flex "><svg  class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7 7V5"/>
                            </svg> <span  class="pt-2">Add Varant</span></button>
                        </div>
                        <ul class="mb-0 list-none shadow mt-10">
                        <li class="-mb-px w-100 mr-2 last:mr-0 cursor-pointer">
                            <a class="text-xs w-100 font-bold uppercase px-5 py-3 leading-normal"
                                    @click="toggleTabs(1)"
                                    :class="{'bg-white border-white border-b-2': openTab !== 1, 'border-b-2 bg-primary border-primary text-white': openTab === 1}">
                                    <span class="flex gap-3"> <img class="w-10 h-10 rounded" src="https://c8n.tradeling.com/img/plain/pim/rs:auto:800::0/f:webp/q:95/up/5fba0c6142480f001bed85d4/61280d015b4563753daf23396c9ef1ee.jpg" alt=""> <span class="pt-2">Parent view</span></span>
                        </a>
                        </li>
                        <li class="-mb-px w-100  mr-2 last:mr-0 cursor-pointer">
                            <a class="text-xs flex justify-between w-100 font-bold uppercase px-5 py-3    leading-normal"
                                    @click="toggleTabs(2)"
                                    :class="{'bg-white border-white border-b-t': openTab !== 2, 'border-b-2 bg-primary border-primary text-white': openTab === 2}">
                                   <span class="flex gap-3"> <img class="w-10 h-10 rounded" src="https://c8n.tradeling.com/img/plain/pim/rs:auto:800::0/f:webp/q:95/up/5fba0c6142480f001bed85d4/61280d015b4563753daf23396c9ef1ee.jpg" alt=""> <span  class="pt-2">twst2</span></span>
                    ...
                    <div class="col-span-3">
                        <div class="p-4">
                            ...
                            <p class="cursor-pointer underline font-bold"  @click="CategorySection = !CategorySection">Edit Category</p>
                            </div>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div class="tab-sidebar p-3">
        ...
        <div class="card-body">
          ...
          <div class="input-wrapper mb-10">
            ...
            <input dir="rtl" class="form-control required" name="Type keyword and press enter (eg. Laptop)..." type="text"
                   value="">
          </div>
        </div>
      </div>
      ...
      <div class="tab-sidebar p-3">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="input-wrapper">
            ...
            <div class="relative flex input-group gap-4 mb-3">
              <input type="text" class="form-control pr-12" placeholder="Carton Length" aria-label="Recipient's username"
                     aria-describedby="button-addon2">
              <div class="absolute right-0 top-0">
                <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                  <option value="0">KG</option>
          ...
          <div class="input-wrapper">
            ...
            <div class="relative flex input-group gap-4 mb-3">
              <input type="text" class="form-control pr-12" placeholder="Carton Height" aria-label="Recipient's username"
                     aria-describedby="button-addon2">
              <div class="absolute right-0 top-0">
                <select data-plugin="customselect" class="p-2 m-1 float-right border-l border-smooth w-1/3">
                  <option value="0">KG</option>
      ...
      <div class="tab-sidebar p-3">
        ...
        <p>Add pricing to your product. You can also create bulk pricing rules to offer price discounts based on quantity
          breaks</p>
        <div class="table-responsive">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div class="tab-sidebar p-3">
        ...
        <h4 class="header-title mt-0 text-capitalize mb-1 ">Additional attributes <span class="text-xs">(optional)</span>
        </h4>
        <div class="input-wrapper">
          <div class="flex">
    ...
    <div  class="fixed bg-modal  inset-0 z-50 flex items-center justify-center">
      ...
      <div class="z-50 bg-white p-6 relative rounded-md shadow w-full md:w-1/2 lg:w-2/3 xl:w-2/5">
        <svg @click="varientModal = false"  class="w-4 h-4 text-gray-800 absolute ltr:right-3  rtl:left-3 cursor-pointer mt-[-10px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
