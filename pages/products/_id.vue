  ...
  methods: {
    ...
    async checkForm() {
      ...
      try {
        ...
        const data = await this.setById({id: this.id, params: {result: {...this.result,rfq_id:this.$route.query?.quote,rfq_product_id:this.$route.query?.rfq_product_id},}, api: this.setApi})
        // if (data) {
        //
