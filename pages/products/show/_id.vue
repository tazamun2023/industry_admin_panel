        ...
        <form>
          ...
          <div id="product_form" class="tab-sidebar p-3">
            ...
            <ValidationProvider name="email" rules="required" v-slot="{ errors }"
                                :custom-messages="{required: $t('global.req', { type: $t('prod.required_unit')}) }">
              <div class="input-group mb-3">
                <label class="w-full" for="mainCategory">{{ $t('prod.Select Unit') }}</label>
                <select :disabled="is_show" class="border p-3 w-50 border-smooth rounded-lg uppercase"
                        v-model="result.unit">
...
<!--                        @updateInput="updateInput"></lang-input>-->
          ...
          <div class="tab-sidebar p-3" v-if="!is_variant ">
            ...
            <upload-files v-if="!is_show" @updateInput="saveAttachment"></upload-files>
          </div>
          <!-- ------------------------------------- -->
          <div class="my-10"></div>
          <!-- ------------------------------------- -->
...
//     },
    ...
    ...mapGetters('common', ['allCategories', 'allTaxRules', 'allAttributes', 'allRejectReasons',
