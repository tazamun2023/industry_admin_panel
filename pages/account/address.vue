    ...
    <div class="card p-4">
      <div class="flex justify-between">
        ...
        <div>
          ...
          <p>Provide information on your billing address and where you would like your items to be picked up from. <br>
            We need your stock pickup location details in order to calculate accurate shipping rates.</p>
        </div>
        <div>
          <button @click="addAddress" class="p-2 leading-3 rounded bg-primary text-white hover:text-primary">Add
            Address</button>
        </div>
      </div>
    </div>
...
<!--            <button class="p-2 leading-3 rounded bg-smooth  hover:text-warning"-->
<!--                    @click="deleteModal = true">Remove</button>-->
<!--            <button class="p-2 leading-3 rounded bg-primary text-white hover:text-primary"-->
<!--                    @click="editAddress(value)">Edit</button>-->
<!--          </div>-->
<!--        </div>-->
...
<!--            <svg class="w-5 h-5 mt-1  text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"-->
...
<!--                      class="p-2 border border-smooth rounded leading-3 w-[60px]">Quit</button>-->
<!--              <button @click.prevent="deleting(value)"-->
<!--                      class="p-2 border border-smooth bg-primary text-white  rounded leading-3 w-[60px] hover:text-primary">Agree</button>-->
<!--            </div>-->
<!--          </template>-->
<!--        </DeleteModal>-->
<!--      </div>-->
...
export default {
  components: { ListPage, ValidationObserver, ValidationProvider, DeleteModal,  AddAddressModel, Modal, GoogleMap },
  mixins: [address],
  data() {
    return {
      addressmodal: false,
