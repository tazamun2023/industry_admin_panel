              ...
              <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
                <div class="card p-4 bg-white mt-20" v-for="(value, index) in list" :key="index">
                  <div class="grid grid-cols-7 gap-4">
                    ...
                    <div class="col-span-5">
                      <div class="flex justify-end">
                        <h5 class="mb-4 ml-4"><a href="">Dalda The Original Vegetable Ghee 1222 kg</a></h5>
                        <div class="p-2 ml-auto">
                          <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                               xmlns="http://www.w3.org/2000/svg" fill="none" viewcard="0 0 21 19">
                      ...
                      <table class="w-full">
                        <tr>
                          <td>
                            <p class="m-0"><strong>Created on:</strong> {{ dateFormat(value.created_at) }}</p>
                            <p class="m-0"><strong>Expires on :</strong> {{ dateFormat(value.expiry_date) }}</p>
                  ...
                  <div class="w-100">
                    <div>
                      ...
                      >
                        ...
                        <div v-if="isCollapsed && activeIndex === index">
                          Hide all products
                        </div>
                        <div v-else>
                          View all products
                      ...
                      <div
                        v-if="isCollapsed && activeIndex === index"
                        class="mt-4 bg-gray-200 p-4 rounded"
                      >
                        <div class="table-responsive">
                          <table class="table mb-0">
                        ...
                        <div class="table-responsive">
                          <table class="table mb-0">
                            ...
                            <tr>
                              ...
                              <td><img style="width:20px;"
                                       src="https://cdn.pixabay.com/photo/2016/10/26/09/19/arbutus-1771003__340.jpg"
                                       alt="zoom" class="img-thumbnail w-48 h-32 object-cover rounded"/></td>
