            ...
            <div class="card-body">
                <div class="row mt-2">
                    <div class="col-md-12">
                        ...
                        <p class="font-14">Explore and bid on Requests For Quotations of verified wholesale buyers from around the world.</p>
                    </div>
                </div>
            </div>
    </div>
        ...
        <div class="flex flex-wrap ">
            ...
            <div class="md:w-1/3 pr-4 pl-4">
                <div class="mb-4">
                    ...
                    <a class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-red-600 text-white hover:bg-red-700 long mb-auto mt-20 ml-4 mr-4" href="">Clear Filter</a>
                </div>
            </div>
        </div>
    </div>
