        ...
        <ul class="flex mb-0 list-none flex-wrap pt-3 w-2/4 pb-4 flex-row">
          <li class="-mb-px mr-2 last:mr-0 cursor-pointer  flex-auto text-center">
            <a class="text-xs font-bold uppercase px-5 py-3  block leading-normal" v-on:click="toggleTabs(1)"
               v-bind:class="{'bg-white border-white border-b': openTab !== 1, 'border-b-2  border-primary': openTab === 1}">
              All Orders
            </a>
          </li>
          <li class="-mb-px mr-2 last:mr-0 cursor-pointer flex-auto text-center">
            <a class="text-xs font-bold uppercase px-5 py-3   block leading-normal" v-on:click="toggleTabs(2)"
               v-bind:class="{'bg-white border-white border-b': openTab !== 2, 'border-b-2  border-primary': openTab === 2}">
               Pending approval
            </a>
          </li>
          <li class="-mb-px mr-2 last:mr-0 cursor-pointer flex-auto text-center">
            <a class="text-xs font-bold uppercase px-5 py-3   block leading-normal" v-on:click="toggleTabs(3)"
               v-bind:class="{'bg-white border-white border-b': openTab !== 3, 'border-b-2    border-primary': openTab === 3}">
               Ready for pickup
            </a>
          </li>
          <li class="-mb-px mr-2 last:mr-0 cursor-pointer flex-auto text-center">
            <a class="text-xs font-bold uppercase px-5 py-3   block leading-normal" v-on:click="toggleTabs(4)"
               v-bind:class="{'bg-white border-white border-b': openTab !== 4, 'border-b-2   border-primary': openTab === 4}">
               Rejected 
            </a>
          </li>
        </ul>
          ...
          <div class="flex-auto ">
              <div class="tab-content input-wrapper tab-space">
               ...
               <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                  <div @click="productTableShow(1)" class="card cursor-pointer my-2 p-4">
                    <div class="flex gap-4 justify-between">
                      <div class="flex gap-4">
                        ...
                        <div>
                          <p>Status</p>
                          <p class="font-bold">Ready to Ship</p>
                        </div>
                      ...
                      <div class="flex gap-4">
                        ...
                        <div>
                          <button class="border border-primary p-2 rounded bg-primary text-white hover:text-primary leading-3">View Order</button>
                        </div>
                      </div>
                    </div>
                    <!-- TW Elements is free under AGPL, with commercial license required for specific uses. See more details: https://tw-elements.com/license/ and contact us for queries at tailwind@mdbootstrap.com --> 
                  ...
                  <div @click="productTableShow(2)" class="card cursor-pointer my-2 p-4">
                    <div class="flex gap-4 justify-between">
                      <div class="flex gap-4">
                        <div class="p-2">
                          <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <div @click="productTableShow(1)" class="card cursor-pointer my-2 p-4">
                    <div class="flex gap-4 justify-between">
                      <div class="flex gap-4">
                        ...
                        <div>
                          <p>Status</p>
                          <p class="font-bold text-warning">Pending Cancellation</p>
                        </div>
                  ...
                  <div @click="productTableShow(2)" class="card cursor-pointer my-2 p-4">
                    <div class="flex gap-4 justify-between">
                      <div class="flex gap-4">
                        ...
                        <div>
                          <p>Status</p>
                          <p class="font-bold text-warning">Cancelled</p>
                        </div>
